...
interface OnlineOrdersCalendarProps {
  selectedDate: Date;
  onDateSelect: (date: Date) => void;
  orders: OnlineOrder[];
}

export const OnlineOrdersCalendar: React.FC<OnlineOrdersCalendarProps> = ({
  selectedDate,
  onDateSelect,
  orders
}) => {
  ...
  return (
    <div className="w-full">
      <Calendar
        ...
        modifiersClassNames={{
          hasOrders: "relative after:absolute after:top-1 after:right-1 after:w-2 after:h-2 after:bg-orange-400 after:rounded-full",
        }}
      />
    </div>
  );
